    ...
    try {
        ...
        const response = await openai.chat.completions.create({
            ...
            messages: [{
                ...
                content: [
                    { type: "text", text: `
                Analyze this image from Midjourney with the purpose of creating a story.
                ...
                Ensure your response exactly matches this format without additional text or markdown.

                In your response, do not use markdown, and remove any double-quotes.
            ` },
                    {
                        type: "image_url",
